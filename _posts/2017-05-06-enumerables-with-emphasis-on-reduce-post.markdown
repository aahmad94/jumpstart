...
<h3>Enumerables primarily traverse or sort collections (ranges, arrays, and hashes) via iteration of a block of code; there's a few big ones: <i>each or each.with_index(), map or collect, all?, none?, any?, count, sort_by, select, and reject</i></h3>
